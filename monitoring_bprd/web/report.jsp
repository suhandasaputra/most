...
//                retrieve: true,
            dom: 'Bfrtip',
            "ajax": {
                "url": "/monitoring_bprd/ReportServlet",
                "dataSrc": ""
            },
            "columns": [
                {data: "id"},
            ...
            "footerCallback": function (row, data, start, end, display) {
                ...
                $(api.column(0).footer()).html('Total Amount : Rp ' + total);
            }
        });
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title"><b>LIST TRANSACTION</b></h3>
                                <div class="col-md-12">
                                    <table id="billermsg" class="table display table-striped table-bordered responsive-utilities jambo_table" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><Strong>TANGGAL TRX</Strong></th>
                                                <th><Strong>NO STRUK</Strong></th>
                                                <th><Strong>DESCRIPTION</Strong></th>
                                                <th><Strong>AMOUNT TRX</Strong></th>
                                                <th><Strong>NOPD</Strong></th>
                                                <th><Strong>SOURCE</Strong></th>
                                            </tr>
                                            <tr class="filters">
                                                <th class="input-filter">ID</th>
                                                <th class="date-filter">TANGGAL TRX</th>
                                                <th class="input-filter">NO STRUK</th>
                                                <th class="input-filter">DESCRIPTION</th>
                                                <th class="input-filter">AMOUNT TRX</th>  
