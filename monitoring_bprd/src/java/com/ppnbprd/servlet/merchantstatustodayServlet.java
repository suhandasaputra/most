 ...
 * @author syukur
 */
public class merchantstatustodayServlet extends HttpServlet {
    
    private static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(merchantstatustodayServlet.class);

    private static final long serialVersionUID = 1L;

    public merchantstatustodayServlet() {
    }
...
//        ppob = DatabaseProcess.getAllPpobs();
        try {
            ...
            ppob = dp.getMerchantstatustoday();
            Gson gson = new Gson();
