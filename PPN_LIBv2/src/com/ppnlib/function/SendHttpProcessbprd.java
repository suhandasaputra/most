 ...
 * @author herrysuganda
 */
public class SendHttpProcessbprd {

    private static final Logger log = Logger.getLogger(SendHttpProcessbprd.class);

    public String sendHttpRequestbprd(String urlpath, String message) {
