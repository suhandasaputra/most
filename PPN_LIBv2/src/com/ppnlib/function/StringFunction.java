...
//        System.out.println("msg.length : " + Integer.toHexString(msg.length()));
    ...
    public static String getDateYYYY_MM_DD(GregorianCalendar calendar) {
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
        String s = formatter.format(calendar.getTime());
        return s;
    }
    
    public static String getDateYYYYMMDD(GregorianCalendar calendar) {
        SimpleDateFormat formatter = new SimpleDateFormat("yyyyMMdd");
        String s = formatter.format(calendar.getTime());
        return s;
    }

    public static String getDateDD_MM_YYYY(GregorianCalendar calendar) {
        SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy");
        String s = formatter.format(calendar.getTime());
        return s;
    }

    public static String getCurrentDateDDMMYYYYHHMMSS2() {
        GregorianCalendar calendar = new GregorianCalendar();
        SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
        String s = formatter.format(calendar.getTime());
        return s;
    ...
    public static String getCurrentDateDDMMYYYYHHMMSS3(GregorianCalendar calendar) {
    ...
    public static String getCurrentTimeHH_mm_ss(GregorianCalendar calendar) {
