<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            <li class="header"><h3>BACKOFFICE</h3></li>
            <!--<li class="active"><a href="list_transaction_yabes.jsp"><i class="fa fa-file"></i><span>Online Monitoring</span></a></li>-->
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="addmerchant.jsp">Add Merchant</a></li>
                </ul>
            </li>
