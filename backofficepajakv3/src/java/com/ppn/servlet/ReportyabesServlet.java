...
//        dao = new ReportYabes();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            try {
                listTransaction = dp.getAlltransactionyabes();
            } catch (ParseException ex) {
                Logger.getLogger(ReportyabesServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
            Gson gson = new Gson();
            JsonElement element = gson.toJsonTree(listTransaction, new TypeToken<List<Reportyabes>>() {
            }.getType());
            JsonArray jsonArray = element.getAsJsonArray();
            response.setContentType("application/json");
            System.out.println("forward : "+jsonArray);
