    ...
    $(document).ready(function () {
        function datatable() {
            table = $("#ppobtable").dataTable({
                retrieve: true,
                "ajax": {
                    "url": "/monitoring_pajak/merchantstatustodayServlet",
                    "dataSrc": ""
                },
                "columns": [
                    {"data": "instituteid"},
...
<body class="hold-transition skin-black-light sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <%@include file='sidebar_today.jsp' %>
                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title"><b>MERCHANT STATUS TODAY</b></h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="col-md-12">
                                    <table id="ppobtable" class="display table table-bordered table-striped" cellspacing="0" width="100%">
                                        <thead>
                                            ...
                                            <tr class="filters">
                                                ...
                                                <th class="input-filter"><strong>Status Today</strong></th>
                                            </tr>
