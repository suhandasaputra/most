...
<script>
    $(document).ready(function () {
        function datatable() {
            table = $("#ppobtoday").dataTable({
                retrieve: true,
                dom: 'Bfrtip',
                "ajax": {
                    "url": "/monitoring_pajak/MonitoringppobtodayServlet",
                    "dataSrc": ""
                },
                "columns": [
                    {"data": "instituteid"},
        ...
        function Timer() {
            ...
            dayTime.innerHTML = 'Date : '+daytime;
        }
...
<body class="hold-transition skin-black-light sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <%@include file='sidebar_monitoringharian.jsp' %>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <!--<li><a href="monitoringtransaksi_ppob_today.jsp">Monitoring Transaksi PPOB Today</a></li>-->
                    <a href="monitoringharian.jsp" class="btn btn-default button-collection">
                        <span>REFRESH</span>
                    </a>
                </ol>
            </section>
                    ...
                    <div class="col-xs-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title"><b>DAILY MONITORING</b></h3>
                                <h3 class="box-title" style="right: 30px;position: absolute" id="day"></h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <table id="ppobtoday" class="display table table-bordered">
                                    <thead>    
                                        <tr>
                                            <th>Institute Id</th>
