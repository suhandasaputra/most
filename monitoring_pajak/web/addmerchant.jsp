    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <b>ONLINE MONITORING PAJAK</b> <br><br>
                    <div align="right">
                                ...
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" maxlength="4" name="instituteid" placeholder="example : instituteid">
                                            </div>
                                        </div> 
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Institute Name</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="institutename" placeholder="example : institutename">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">POS ID</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" maxlength="3" name="posid" placeholder="example : posid" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">ZIP CODE</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" maxlength="5" name="poscode" placeholder="example : poscode">
                                            </div>
                                        </div>
