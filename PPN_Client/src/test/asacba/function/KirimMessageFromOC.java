 ...
 * @author herrysuganda
 */
public class KirimMessageFromOC {
...
//        String respMsg = new SendHttpProcess().sendHttpRequest("http://localhost:8080/PPN/OnlineCustomer", reqMsg);
        String respMsg = new SendHttpProcess().sendHttpRequest("http://app.q-payment.com:8080/PPN/OnlineCustomer", reqMsg);
